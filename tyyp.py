...
s = requests.Session()
ck = environ.get("tyypCK") if environ.get("tyypCK") else ""
accounts = [
    {"username": str(ck.split("@")[0]), "password": str(ck.split("@")[1])},
    # {"username": "2222", "password": "2222"},
    # {"username": "3333", "password": "3333"},
    # 添加更多账号和密码格式同上一行
]
# 填入pushplus token
pushplus_token = "14541fa6260140b6996df4faf2cf5731"
